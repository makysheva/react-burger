        ...
        <div className={styles.footer__content}>
          ...
          <address className={styles.footer__address}>
            <div className={styles.footer__contact}>
              ...
              <a className={styles.footer__phone} href="#">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span>+7(930)833-10-10</span>
              </a>
            </div>

            <div className={styles.footer__contact}>
              <h2 className={cn(styles.footer__title, styles.footer__title_sn)}>Мы в соцсетях</h2>
          ...
          <div className={styles.footer__development}>
            ...
            <p>
              Developer:{" "}
              <a href="mailto:makysheva.aliya@gmail.com">Aliya Makysheva</a>
            </p>
          </div>
        </div>
      </Layout>
